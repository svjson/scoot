...
class ScootError(Exception):
    ...
    def __init__(self, error, message, type=ScootErrorType.INTERNAL_ERROR, additional={}):
        self.error = error
        self.type = type
...
class ScootConnectionException(ScootError):
    ...
    def __init__(self, error, message, connection_name=""):
        super().__init__(error, message, ScootErrorType.CONNECTION_ERROR, {"connection": connection_name})
...
class ScootDriverException(ScootError):
    ...
    def __init__(self, error, message, driver):
        super().__init__(error, message, ScootErrorType.INTERNAL_ERROR,{"driver": driver})
