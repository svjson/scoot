;;; scoot-ddl.edit.keybinds.test.el --- summary -*- lexical-binding: t -*-
...
(ert-deftest scoot-ddl--keybinding-overlays--q->quit-window--or--self-insert-command ()
  (with-fake-connection "nexartrade" (nexartrade-fake-connection)
    (let ((ddl-buffer (scoot-ddl--open-edit-mode (nexartrade-result-context--table-users))))
...
(ert-deftest scoot-ddl--keybinding-overlays--g->scoot-buffer-refresh--or--self-insert-command ()
  (with-fake-connection "nexartrade" (nexartrade-fake-connection)
    (let ((ddl-buffer (scoot-ddl--open-edit-mode (nexartrade-result-context--table-users))))
      (with-current-buffer ddl-buffer
        (let ((query-block (scoot-widget--get-widget :type 'query-block
                                                     :name 'query-block)))
          (interactively-goto-line 1)
          (should (equal (key-binding (kbd "g")) #'scoot-buffer-refresh))
          (interactively-goto-line (1- (plist-get query-block :widget-start-line)))
          (should (equal (key-binding (kbd "g")) #'scoot-buffer-refresh))
          (interactively-goto-line (plist-get query-block :widget-start-line))
          (should (equal (key-binding (kbd "g")) #'self-insert-command))
          (kill-buffer ddl-buffer))))))



;;; scoot-ddl.edit.keybinds.test.el ends here
