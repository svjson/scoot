;;; scoot-widget.buffer-positions.multiline.test.el --- summary -*- lexical-binding: t -*-
...
(ert-deftest scoot-widget--point->position--multiline-visible-to-shadow ()
  (with-temp-buffer
    (insert "\n\n")
...
(ert-deftest scoot-widget--point->position--multiline-visible-to-visible ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Widget Start"
...
(ert-deftest scoot-widget--point->position--multiline-shadow-to-visible ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
...
(ert-deftest scoot-widget--point->position--multiline-shadow-to-shadow ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Content Start"
...
(ert-deftest scoot-widget--point->point--multiline-visible-to-shadow ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Widget Start"
...
(ert-deftest scoot-widget--point->point--multiline-visible-to-visible ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Widget Start"
...
(ert-deftest scoot-widget--point->point--multiline-shadow-to-visible ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Content Start"
...
(ert-deftest scoot-widget--point->point--multiline-shadow-to-shadow ()
  (with-temp-buffer
    (insert "\n\n")
    (let ((widget (scoot-qb--insert-query-block! "SELECT\n  *\nFROM\n  somewhere" '(:width 50)))
          (cases (list (list :case "At Content Start"
...
;;; scoot-widget.buffer-positions.multiline.test.el ends here
